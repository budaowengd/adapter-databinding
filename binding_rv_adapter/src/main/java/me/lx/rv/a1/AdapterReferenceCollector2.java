...
class AdapterReferenceCollector2 {
     ...
     */
    static <T, A extends BindingRecyclerViewAdapter22<T>> WeakReference<A> createRef(A adapter, ObservableList<T> items, ObservableList.OnListChangedCallback callback) {
    ...
    static class AdapterRef<T, A extends BindingRecyclerViewAdapter22<T>> extends WeakReference<A> {
