 ...
 * 因为当分组列表发生变化时，需要及时更新分组列表的组结构{@link GroupedRecyclerViewAdapter222#mStructures}
 */
public abstract class GroupedRecyclerViewAdapter222
        extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    public static final int TYPE_HEADER = 89274;
    public static final int TYPE_FOOTER = 89275;
    public static final int TYPE_CHILD = 89276;
    ...
    public GroupedRecyclerViewAdapter222(Context context) {
        this(context, false);
    }

    public GroupedRecyclerViewAdapter222(Context context, boolean useBinding) {
        mContext = context;
        ...
        if (type == TYPE_HEADER) {
            if (mOnHeaderClickListener != null) {
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (mOnHeaderClickListener != null) {
                            mOnHeaderClickListener.onHeaderClick(GroupedRecyclerViewAdapter222.this,
            ...
            if (mOnFooterClickListener != null) {
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (mOnFooterClickListener != null) {
                            mOnFooterClickListener.onFooterClick(GroupedRecyclerViewAdapter222.this,
                                    (BaseViewHolder) holder, groupPosition);
                        }
                    }
                });
            ...
            if (mOnChildClickListener != null) {
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (mOnChildClickListener != null) {
                            mOnChildClickListener.onChildClick(GroupedRecyclerViewAdapter222.this,
    ...
    public interface OnHeaderClickListener {
        void onHeaderClick(GroupedRecyclerViewAdapter222 adapter, BaseViewHolder holder, int groupPosition);
    }

    public interface OnFooterClickListener {
        void onFooterClick(GroupedRecyclerViewAdapter222 adapter, BaseViewHolder holder, int groupPosition);
    }

    public interface OnChildClickListener {
        void onChildClick(GroupedRecyclerViewAdapter222 adapter, BaseViewHolder holder,
                          int groupPosition, int childPosition);
    }
}