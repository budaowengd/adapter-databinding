...
// * 因为当分组列表发生变化时，需要及时更新分组列表的组结构[TwoLevelGroupedRecyclerViewAdapter222.mStructures]
// *
// * 1、T泛型: 组对象
// * 2、C泛型: 组里的孩子
// * 2级分组
...
// *  group1-footer
// */
//abstract class TwoLevelGroupedRecyclerViewAdapter222<G, CG, CC> :
...
//    }
//
//    fun setChildGroupEmptyRemoveGroup(isRemoveHeaderWhenChildEmpty: Boolean = true): TwoLevelGroupedRecyclerViewAdapter222<G, CG, CC> {
...
//        private var groupAdapter: TwoLevelGroupedRecyclerViewAdapter222<G, *, *>,
